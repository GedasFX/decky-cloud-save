...
export const Content: VFC<{}> = () => {
  ...
  setInterval(async () => {
    if (
      (!ApplicationState.getAppState().currentState.playing )&&
      ApplicationState.getAppState().currentState.bisync_enabled &&
      (!ApplicationState.getAppState().currentState.syncing)
    ) {
